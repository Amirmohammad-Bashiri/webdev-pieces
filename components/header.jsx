...
function Header() {
  ...
  const lightButton = (
    <button
      ...
      className="p-3 bg-gray-200 rounded focus:border focus:border-dotted focus:border-gray-500">
      {lightIcon}
    </button>
  );
  ...
  const darkButton = (
    <button
      ...
      type="button"
      onClick={themeHandler}
      className="p-3 bg-gray-800 rounded focus:border focus:border-dotted focus:border-gray-100">
      {darkIcon}
    </button>
  );
